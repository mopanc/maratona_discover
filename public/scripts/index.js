...
$("#nav-colors > .btn").click(function () {
  if ($(this).is("#pink")) {
    $(".navbar1").css("background", "linear-gradient(to right, #ff5858, #f857a6)");
    $(".dropdown-menu").css("background", "#ff5858");
  }
  else if ($(this).is("#red")) {
    $(".navbar1").css("background", "linear-gradient(to right, #d31027, #ea384d)");
    $(".dropdown-menu").css("background", "#d31027");
  }
  else if ($(this).is("#purple")) {
    $(".navbar1").css("background", "linear-gradient(to right, #41295a, #2f0743)");
    $(".dropdown-menu").css("background", "#41295a");
  }
  else if ($(this).is("#blue")) {
    $(".navbar1").css("background", "linear-gradient(to right, #396afc, #2948ff)");
    $(".dropdown-menu").css("background", "#396afc");
  }
  else if ($(this).is("#green")) {
    $(".navbar1").css("background", "linear-gradient(to right, #add100, #7b920a)");
    $(".dropdown-menu").css("background", "#add100");
  }
  else if ($(this).is("#yellow")) {
    $(".navbar1").css("background", "linear-gradient(to right, #f7971e, #ffd200)");
    $(".dropdown-menu").css("background", "#f7971e");
  }
  else if ($(this).is("#orange")) {
    $(".navbar1").css("background", "linear-gradient(to right, #e43a15, #e65245)");
...
$("#font-colors > .btn").click(function () {
  if ($(this).is("#white")) {
    $(".navbar1 .fa, .link, a").css("color", "white");
    $("body, header").css("background", "#41414C");
  }
  else if ($(this).is("#black")) {
    $(".navbar1 .fa, .link, a").css("color", "black");
    $("body, header").css("background", "white");
  }
})
...
$("#edges > .btn").click(function () {
  if ($(this).is("#rounded")) {
    $(".rounded_corner").css("border-radius", "8px");
    if ($(window).width() > 768) {
      $(".dropdown-menu").css({
    ...
    $(".rounded_corner").css("border-radius", "0");
    $(".dropdown-menu").css({
